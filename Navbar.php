<nav class="navbar navbar-expand-lg">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<a class="nav-link" href="/SiteWeb/Inscription.php">Inscription</a>
		<a class="nav-link" href="/SiteWeb/connexion.php">Connexion</a>
		</form>
		<a class="nav-item" href="/SiteWeb/Panier/panier.php"><img class="Panier_btq" src="/SiteWeb/img/panier1.png"></a>
	</div>
</nav>
