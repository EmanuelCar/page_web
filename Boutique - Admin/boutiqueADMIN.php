	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="caroussel_img carouf" src="#" alt="First slide">
			</div>
			<div class="carousel-item">
				<img class="caroussel_img carouf" src="#" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="caroussel_img carouf" src="#" alt="Third slide">
			</div>
		</div>
